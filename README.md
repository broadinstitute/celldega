...
standalone HTML snippet. The snippet remains fully interactive but no
longer communicates with Python. This is handy on platforms like Kaggle
or Colab that have limited widget support.
