...
export const calc_viewport = async ({ height, width, zoom, target }, deck_ist, layers_obj, viz_state) => {
    ...
    if (tiles_in_view.length < max_tiles_to_view) {
        ...
        update_bar_graph(svg_bar_cluster, new_bar_data_cell, viz_state.cats.color_dict_cluster, bar_callback_cluster, viz_state.cats.selected_cats, deck_ist, layers_obj, viz_state)
        ...
        if (viz_state.close_up) {
            ...
            update_bar_graph(svg_bar_gene, viz_state.genes.gene_counts, viz_state.genes.color_dict_gene, bar_callback_gene, selected_genes, deck_ist, layers_obj, viz_state)
            update_bar_graph(svg_bar_cluster, viz_state.cats.cluster_counts, viz_state.cats.color_dict_cluster, bar_callback_cluster, viz_state.cats.selected_cats, deck_ist, layers_obj, viz_state)
